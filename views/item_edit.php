    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
                ...
                <form action="index.php?modul=barang&fitur=editBarang&id=<?php echo $data->item_id; ?>" method="POST">
                    <!-- Nama Role -->
                    <div class="mb-4">
                    ...
                    <!-- Role Deskripsi -->
                    <div class="mb-4">
                        <label for="item_desc" class="block text-gray-700 text-sm font-bold mb-2">Role Harga:</label>
                        ...
                        ><?php echo htmlspecialchars($data->item_desc);?></textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="item_status" name="item_status" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                            ...
                            <option value=1 <?php echo ($data->item_status == 1) ?'selected' :'' ?>>Baru</option>
                            <option value=0 <?php echo ($data->item_status == 0) ?'selected' :'' ?>>Bekas</option>
                        </select>
                    </div>
